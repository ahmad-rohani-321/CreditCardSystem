    ...
    public partial class TransactionActions : XtraForm
    {
        ...
        private void txtTransactionTypes_SelectedIndexChanged(object sender, EventArgs e)
        {
            switch (txtTransactionTypes.SelectedIndex)
            {
                ...
                case 2:
                    // do exchange
                    txtFromAccount.Properties.DataSource = _parties.GetParties();
                    txtToAccount.Properties.DataSource = _parties.GetParties();
                    break;
                case 3:
                    // do receive
        ...
        private bool ValidateForm()
        {
            ...
            else if ((txtTransactionTypes.SelectedIndex == 0) && _fromBalance <= 0)
            {
                txtValue.ErrorText = "د نوموړي شخص بلانس صفر دی";
                isValid = false;
            }
            else
            {
